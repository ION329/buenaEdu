...
<div style="padding:30px 10%;">
	...
	<div class="contEstandar p30 bWhite mb20 lCreate2">
    
    	
        <a class="bBasic7 rr40 color666 taC cP fR p1025" style="margin-top:-15px;"><img src="resources/img/icons/excel.png" /> &nbsp; Excel</a>
        <a class="bBasic6 rr40 bBlue colorfff taC cP bCreate2 fR p1025" style="margin-top:-15px; margin-right:10px;"><img src="resources/img/icons/prof.png" /> &nbsp; Agregar docente</a>
	...
	<div class="dCreate2 dN">
        <div class="contEstandar p30 bWhite mb20">
            ...
            <div class="row">
                ...
                <div class="col-sm-2 col-xs-2 mb20 taR" style="padding-top:4px;">
                    <label class="ff1 color999">Fecha de nacimiento:</label>
                </div>
                <div class="col-sm-2 col-xs-2 mb20">
                    <select class="selSt rr5">
                        <option>Día</option>
        ...
        <div class="taR">
			<a class="bBasic2 rr40 t16 ff2 color999 bGray taC cP bCreated2">Guardar</a>
            <a class="bBasic2 rr40 t16 ff2 color999 bGray taC cP bCreated2">Cancelar</a>
		</div>

	</div>
    
    <br><br>
    <div class="taR lCreate2">
