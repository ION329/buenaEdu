				...
				<div class="col-xs-12">
					<div class="row m0 p20" style="border-bottom: 1px solid #ccc">
						<div class="col-xs-6">
							...
							<div class="tab">
								<div class="tabIn">
									Intensidad horaria: <b>150 Horas</b>
								</div>
								<div class="tabIn taR">
									<span>Grupos Asignados: 3</span>		
								</div>
							</div>
						</div>
						...
						<div class="col-xs-4 taR">
							...
							<div>
								<a class="bBasic1 rr5 bAzulBE taC p1020 cP" style="border: 1px solid;"><b class="colorfff">Enviar para revisión</b></a>	
							</div>
        			...
        			<div class="tab-content">
		                <div id="informacion" class="tab-pane fade in active">
                			<div class="p20">
								...
								<div class="aSS mb30">Guardar</div>
                		...
                		<div id="objetivos" class="tab-pane fade">
							<div class="p20">
								...
								<div class="tab mb20">
									...
									<div class="tabIn taR">
										<a class="bBasic3 rr5 taC bBlue colorfff" href=""><b>Nuevo Objetivo</b></a>
									</div>
								</div>
