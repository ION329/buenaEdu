...
<div class="rol_estudiante bodBuddy">
    ...
    <div class="menuLateral col-sm-2 col-xs-2 p0">
        <div ng-include src=" 'view/plataforma/general/zona/menuEstudiante3.php' "></div>
    </div>
							...
							<div class="navBarLog ff5 taC col-sm-12 col-xs-12 vcenter p0">
								<ul class="nav nav-tabs" role="tablist">
									<li class="taC" role="presentation" style="float:right;">
										<a class="btn-radius-bykr" aria-expanded="true" href="#mater3" target="_self" aria-controls="p3" role="tab" data-toggle="tab"> AGENDA </a>
									</li>
									<li class="taC" role="presentation" style="float:right;">
										<a class="btn-radius-bykr" aria-expanded="true" href="#mater2" target="_self" aria-controls="p3" role="tab" data-toggle="tab"> ASISTENCIA </a>
									</li>
									<li class="taC active" role="presentation" style="float:right;">
										<a class="btn-radius-bykr" aria-expanded="true" href="#mater1" target="_self" aria-controls="p3" role="tab" data-toggle="tab"> HORARIO </a>
									</li>
								</ul>
							</div>
						</div>
