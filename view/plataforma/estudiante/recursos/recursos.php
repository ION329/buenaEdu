...
<div class="rol_estudiante bodBuddy">
    ...
    <div class="menuLateral col-sm-2 col-xs-2 p0">
        <div ng-include src=" 'view/plataforma/general/zona/menuEstudiante7.php' "></div>
    </div>
    <div class="contSingular bGray col-sm-10 col-xs-10 p20">
        <!--<img src="resources/img/temporal/images/e-recursos_01.jpg">-->
...
<div class="contEstandar bWhite rr5 p10">
	...
	<div class="row m0 mb15">
		...
		<div class="col-xs-3 col-sm-3 vcenter p0">
			<span class="colorVerde2 ff2 t24 dIB">Recursos</span>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="row m0">
		...
		<div class="derecha col-xs-4 col-sm-4 p0"> <!-- Derecha -->
			...
			<div class="row m0" style="margin-top:-1px;">
				<div class="p30 bS1">
