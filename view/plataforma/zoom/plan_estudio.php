<div class="contEstandar bWhite rr5 p30 ng-scope">

			<div class="row dCambiar1">
			...
			<div class="row dCambiar2 m0 dN">
			    ...
			    <div class="col-sm-4 col-xs-4 p0">
			    	<!-- El include de plan_estudio_personal.php va en Personal Academico Plan de Estudio y el plan_estudio_profesor va en Profesor Materias Asignadas-->
