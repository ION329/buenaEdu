...
<div class="row m0 dAsistencia1">
	...
	<div class="col-xs-7 col-sm-7 p0 dCambiar2 dN">
		...
		--><div class="col-xs-3 col-sm-3 p0 taR vcenter">
				<a class="bBasic3 rr40 t14 color000 taC cP bAbrir-bykr p510 bWhite ff2 dIB">Responder<img src="resources/img/icons/e4.png" class="dIB" width="20"></a>
			</div>
		</div>

		<div class="dAbre-bykr1 dN">
