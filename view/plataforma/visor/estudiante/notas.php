<div class="dBeycker1">
              ...
              <table class="table mb0">
                  <thead>
                    <tr>
                      ...
                      <th class="taC">(1) PE</th>
                      <th class="taC">(2) PE</th>
                      <th class="taC">(3) PE</th>
                      <th class="taC">EF</th>
                      <th class="taC">NF</th>
                    </tr>
                  </thead>
  ...
  <div class="col-sm-3 col-xs-3 vcenter fv_lm">
    ...
    <br>
    <span class="colorVirde ff2">AS</span> &nbsp;
  ...
  <div class="col-sm-3 col-xs-3 vcenter fv_lm">
    ...
    <br>
    <span class="colorVirde ff2">EF</span> &nbsp;
    <span class="color666">Evaluación Final</span>
  </div>
  </div>
  ...
  <div class="fv_ultc">Nov 12 - 15</div>
    <div class="contEstandar rr5 bWhite p10 fv_ultc0">
      <div class="taR vcenter colorVerde ff2 t24 fv_flod">4.0</div>
      <div class="colorfff bVirde dIB rr10 p10 mb5" style="padding:2px 2px;">&nbsp; E &nbsp;</div>
  ...
  <div class="fv_ultc">Nov 12 - 15</div>
    <div class="contEstandar rr5 bWhite p10 fv_ultc0">
      <div class="taR vcenter colorRed ff2 t24 fv_flod">1.2</div>
      <div class="colorfff bVirde dIB rr10 p10 mb5" style="padding:2px 2px;">&nbsp; AS &nbsp;</div>
    ...
    <div class="row">
      ...
      <div class="titSep2 colorVirde ff2 tU t14">
          <div class="col-xs-1 col-sm-1 vcenter">
              <span class="colorVirde ff2 tU t16 dIB">Detalle</span>
          </div><!--
