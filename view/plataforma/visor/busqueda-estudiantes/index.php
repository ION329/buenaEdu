...
<div class="rol_estudiante bodBuddy">
    ...
    <div class="menuLateral col-sm-2 col-xs-2 p0">
        <div ng-include src=" 'view/plataforma/general/zona/menuVisor.php' "></div>
    </div>
    <div class="contSingular bGray col-sm-10 col-xs-10">
        <div ng-include src=" 'view/plataforma/visor/busqueda-estudiantes/buscar-estudiantes.php' "></div>
        <br /><br /><br />
    </div>
